...
DebugRoom_MapEvents:
	...
	warp_event 35, 17, ILEX_FOREST, 1 ; east warp
	warp_event  5, 35, ILEX_FOREST, 1 ; southwest warp
	warp_event 19, 34, ILEX_FOREST, 1 ; southern warp
	warp_event 33, 33, ILEX_FOREST, 1 ; southeast warp
