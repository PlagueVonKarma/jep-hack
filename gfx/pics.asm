...
WaruchuFrontpic:	 INCBIN "gfx/pokemon/waruchu/front.animated.2bpp.lz"
WaruchuBackpic:	 INCBIN "gfx/pokemon/waruchu/back.2bpp.lz"
SoneggFrontpic:	 INCBIN "gfx/pokemon/sonegg/front.animated.2bpp.lz"
SoneggBackpic:	 INCBIN "gfx/pokemon/sonegg/back.2bpp.lz"
CacawphonyFrontpic:	 INCBIN "gfx/pokemon/cacawphony/front.animated.2bpp.lz"
CacawphonyBackpic:	 INCBIN "gfx/pokemon/cacawphony/back.2bpp.lz"
TrebirFrontpic:	 INCBIN "gfx/pokemon/trebir/front.animated.2bpp.lz"
TrebirBackpic:	 INCBIN "gfx/pokemon/trebir/back.2bpp.lz"
SakurazeFrontpic:	 INCBIN "gfx/pokemon/sakuraze/front.animated.2bpp.lz"
SakurazeBackpic:	 INCBIN "gfx/pokemon/sakuraze/back.2bpp.lz"
AmanobiFrontpic:	 INCBIN "gfx/pokemon/amanobi/front.animated.2bpp.lz"
AmanobiBackpic:	 INCBIN "gfx/pokemon/amanobi/back.2bpp.lz"
TrustanFrontpic:	 INCBIN "gfx/pokemon/trustan/front.animated.2bpp.lz"
TrustanBackpic:	 INCBIN "gfx/pokemon/trustan/back.2bpp.lz"
KuwaguardFrontpic:	 INCBIN "gfx/pokemon/kuwaguard/front.animated.2bpp.lz"
KuwaguardBackpic:	 INCBIN "gfx/pokemon/kuwaguard/back.2bpp.lz"
TonquitoFrontpic:	 INCBIN "gfx/pokemon/tonquito/front.animated.2bpp.lz"
TonquitoBackpic:	 INCBIN "gfx/pokemon/tonquito/back.2bpp.lz"
...
LuanboFrontpic:	 INCBIN "gfx/pokemon/luanbo/front.animated.2bpp.lz"
LuanboBackpic:	 INCBIN "gfx/pokemon/luanbo/back.2bpp.lz"
GranboFrontpic:	 INCBIN "gfx/pokemon/granbo/front.animated.2bpp.lz"
GranboBackpic:	 INCBIN "gfx/pokemon/granbo/back.2bpp.lz"
AngoreFrontpic:	 INCBIN "gfx/pokemon/angore/front.animated.2bpp.lz"
AngoreBackpic:	 INCBIN "gfx/pokemon/angore/back.2bpp.lz"
EucalaFrontpic:	 INCBIN "gfx/pokemon/eucala/front.animated.2bpp.lz"
EucalaBackpic:	 INCBIN "gfx/pokemon/eucala/back.2bpp.lz"
KiwookedFrontpic:	 INCBIN "gfx/pokemon/kiwooked/front.animated.2bpp.lz"
...
CharmadaFrontpic:     INCBIN "gfx/pokemon/charmada/front.animated.2bpp.lz"
CharmadaBackpic:      INCBIN "gfx/pokemon/charmada/back.2bpp.lz"
...
ToedscoolFrontpic:	INCBIN "gfx/pokemon/toedscool/front.animated.2bpp.lz"
ToedscoolBackpic:      INCBIN "gfx/pokemon/toedscool/back.2bpp.lz"
ToedscruelFrontpic:	INCBIN "gfx/pokemon/toedscruel/front.animated.2bpp.lz"
ToedscruelBackpic:      INCBIN "gfx/pokemon/toedscruel/back.2bpp.lz"
