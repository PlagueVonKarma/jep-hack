...
; Down the line, consider Buu, Bunice/Bundra, etc.
	...
	dbw 43, CORSOLA
	dbw 44, QUAGSIRE
	dbw 45, SHELLDER ; DISTURBAN
	dbw 44, SHELLDER ; DISTURBAN
	dbw 44, SLOWKING
	end_grass_wildmons
	...
	dbw 53, CORSOLA
	dbw 54, QUAGSIRE
	dbw 55, SHELLDER ; DISTURBAN
	dbw 54, SHELLDER ; DISTURBAN
	dbw 54, SLOWKING
	end_grass_wildmons
...
; REVIEW: This is a lot of Pokemon in one place. How easy is it to find what you want?
...
; Built off Silver data to add Snubbull and have Meowth in the daytime.
	...
	dbw 23, MAGNEMITE
	dbw 22, MOIBELLE
	dbw 21, MURKROW ; Replacing Tauros and Miltank at night to replicate Crystal's idea.
	dbw 21, MURKROW ; To me, the bovines sleeping makes sense.
	dbw 23, NOCTOWL
	end_grass_wildmons
...
; At night, Hoothoot is seen instead of Zubat, and Murkrow is a 10% encounter.
	...
	db 10 percent, 10 percent, 10 percent ; encounter rates: morn/day/nite
	; morn
	dbw 31, FLAAFFY ; From Gold
	dbw 30, GIRAFARIG ; From Gold
	dbw 33, FARFETCH_D ; LUXWAN
	dbw 32, FURRET
	dbw 33, FURRET
	dbw 32, FURRET
	dbw 34, TANGELA
