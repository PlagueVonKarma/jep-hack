...
BulbasaurEvosAttacks:
	...
	dbw 15, POISONPOWDER
	dbw 15, SLEEP_POWDER
	dbw 15, STUN_SPORE ; RG proto & SW97
	dbw 20, RAZOR_LEAF
	dbw 26, SWEET_SCENT
	dbw 32, GROWTH
	dbw 38, SYNTHESIS
	dbw 44, PETAL_DANCE ; RG proto
	dbw 49, TOXIC ; KEP
	dbw 55, SOLARBEAM
...
CharmanderEvosAttacks:
	...
	dbw 1, GROWL
	dbw 7, EMBER
	dbw 10, METAL_CLAW ; FRLG
	dbw 14, SMOKESCREEN
	dbw 19, RAGE
	dbw 25, SCARY_FACE
	dbw 31, FLAMETHROWER
	dbw 34, SEISMIC_TOSS ; KEP & RBY TM
	dbw 37, SLASH
	dbw 43, DRAGON_RAGE
	dbw 49, FIRE_SPIN
	dbw 55, FIRE_BLAST ; KEP & TM
	db 0 ; no more level-up moves

CharmeleonEvosAttacks:
	dbbw EVOLVE_LEVEL, 36, CHARIZARD
	dbww EVOLVE_TRADE, METAL_COAT, CHARMADA
	db 0 ; no more evolutions
	dbw 1, SCRATCH
	dbw 1, GROWL
	dbw 7, EMBER
	...
	dbw 27, SCARY_FACE
	dbw 33, FLAMETHROWER
	dbw 36, SEISMIC_TOSS ; KEP & RBY TM
	dbw 41, SLASH
	dbw 47, DRAGON_RAGE
	dbw 53, FIRE_SPIN
	dbw 61, FIRE_BLAST ; KEP & TM
	db 0 ; no more level-up moves
...
SquirtleEvosAttacks:
	dbbw EVOLVE_LEVEL, 16, WARTORTLE ; Completely retooled to RB proto & Totartle
	db 0 ; no more evolutions
	dbw 1, TACKLE
	dbw 1, TAIL_WHIP
	dbw 7, ABSORB ; New!
	...
	dbw 41, PETAL_DANCE ; New!
	dbw 47, WATERFALL ; New!
	db 0 ; no more level-up moves
...
KotoraEvosAttacks:
	...
	dbww EVOLVE_ITEM, THUNDERSTONE, RAITORA
	db 0 ; no more evolutions
	dbw  1, THUNDERSHOCK
	dbw  1, TACKLE
	dbw  7, LEER
...
RattataEvosAttacks:
	...
	dbw 1, TAIL_WHIP
	dbw 6, QUICK_ATTACK
	dbw 11, GROWL ; RG proto
	dbw 15, HYPER_FANG
	dbw 20, FOCUS_ENERGY
	dbw 25, PURSUIT
	dbw 30, SUPER_FANG
	dbw 36, THRASH ; RG proto
	dbw 42, SLASH ; RG proto
	db 0 ; no more level-up moves
...
RaticateEvosAttacks:
	...
	dbw 27, PURSUIT
	dbw 32, SUPER_FANG
	dbw 40, THRASH ; RG proto
	dbw 46, SLASH ; RG proto
	db 0 ; no more level-up moves
...
SpearowEvosAttacks:
	...
	dbw 13, FURY_ATTACK
	dbw 19, PURSUIT
	dbw 25, WING_ATTACK ; RG proto
	dbw 31, MIRROR_MOVE
	dbw 37, DRILL_PECK
	dbw 43, AGILITY
	dbw 49, DOUBLE_TEAM ; SW97
	db 0 ; no more level-up moves
...
FearowEvosAttacks:
	...
	dbw 13, FURY_ATTACK
	dbw 19, PURSUIT
	dbw 27, WING_ATTACK ; RG proto
	dbw 33, MIRROR_MOVE
	dbw 39, DRILL_PECK
	dbw 47, AGILITY
	dbw 53, DOUBLE_TEAM ; SW97
	db 0 ; no more level-up moves
...
RaichuEvosAttacks:
	dbww EVOLVE_TRADE, -1, GOROCHU ; due to being a starter, moveset update
	db 0 ; no more evolutions
	dbw 1, THUNDERSHOCK
	dbw 1, GROWL
	dbw 6, TAIL_WHIP
...
SandshrewEvosAttacks:
	...
	dbw 34, SWIFT
	dbw 40, SANDSTORM
	dbw 46, SWORDS_DANCE ; LGPE
	dbw 51, EARTHQUAKE ; LGPE & KEP
	db 0 ; no more level-up moves
...
SandslashEvosAttacks:
	...
	dbw 36, SWIFT
	dbw 44, SANDSTORM
	dbw 50, SWORDS_DANCE ; LGPE
	dbw 55, EARTHQUAKE ; LGPE & KEP
	db 0 ; no more level-up moves
...
NidoranFEvosAttacks:
	...
	dbw 1, GROWL
	dbw 1, SCRATCH
	dbw 8, SAND_ATTACK ; RG proto
	dbw 12, DOUBLE_KICK
	dbw 17, POISON_STING
	dbw 23, TAIL_WHIP
	dbw 29, BITE
	dbw 35, FURY_SWIPES
	dbw 41, GLARE ; RG proto
	dbw 47, CRUNCH ; FRLG
	db 0 ; no more level-up moves

NidorinaEvosAttacks:
	dbww EVOLVE_ITEM, POISON_STONE, NIDOQUEEN
	dbbw EVOLVE_LEVEL, 36, NIDOQUEEN
	dbww EVOLVE_ITEM, MOON_STONE, NIDOREIGN
	db 0 ; no more evolutions
	dbw 1, GROWL
	dbw 1, SCRATCH
	dbw 8, SAND_ATTACK ; RG proto
...
NidoranMEvosAttacks:
	...
	dbw 17, POISON_STING
	dbw 23, FOCUS_ENERGY
	dbw 29, ROAR ; RG proto
	dbw 35, FURY_ATTACK
	dbw 41, SLASH ; RG proto
	dbw 47, HORN_DRILL
	db 0 ; no more level-up moves

NidorinoEvosAttacks:
	dbww EVOLVE_ITEM, POISON_STONE, NIDOKING
	...
	dbw 19, POISON_STING
	dbw 25, FOCUS_ENERGY
	dbw 31, ROAR ; RG proto
	dbw 39, FURY_ATTACK
	dbw 45, SLASH ; RG proto
	dbw 51, HORN_DRILL
	db 0 ; no more level-up moves
...
VulpiiiEvosAttacks:
	...
	dbw 7, QUICK_ATTACK
	dbw 13, ROAR
	dbw 17, DOUBLE_TEAM ; SW97
	dbw 21, CONFUSE_RAY
	dbw 25, SAFEGUARD
	dbw 29, FLAMETHROWER
	dbw 33, FORESIGHT ; SW97
	dbw 37, FIRE_SPIN
	dbw 41, CURSE ; 99 Proto
	db 0 ; no more level-up moves
...
VulpixEvosAttacks:
	...
	dbw 7, QUICK_ATTACK
	dbw 13, ROAR
	dbw 19, DOUBLE_TEAM ; SW97
	dbw 23, CONFUSE_RAY
	dbw 27, SAFEGUARD
	dbw 33, FLAMETHROWER
	dbw 37, FORESIGHT ; SW97
	dbw 41, FIRE_SPIN
	dbw 47, CURSE ; 99 Proto
	db 0 ; no more level-up moves
...
VileplumeEvosAttacks:
	...
	dbw 1, STUN_SPORE
	dbw 1, PETAL_DANCE
	dbw 55, SLUDGE_BOMB ; TM, made to match Bellossom
	db 0 ; no more level-up moves
...
CoinpurEvosAttacks:
	...
	dbw 5, PAY_DAY
	dbw 8, BITE
	dbw 13, QUICK_ATTACK ; RG proto
	dbw 19, FAINT_ATTACK
	dbw 25, SCREECH
	dbw 31, FURY_SWIPES
	dbw 37, SLASH
	dbw 42, DOUBLE_TEAM ; KEP
	db 0 ; no more level-up moves
...
MeowthEvosAttacks:
	...
	dbw 33, FURY_SWIPES
	dbw 41, SLASH
	dbw 46, DOUBLE_TEAM ; KEP
	dbw 52, BODY_SLAM ; RBY TM
	db 0 ; no more level-up moves
...
PsyduckEvosAttacks:
	...
	dbw 19, CONFUSION
	dbw 23, FURY_SWIPES
	dbw 27, AMNESIA ; Stadium & HGSS
	dbw 31, GLARE ; RG proto
	dbw 35, PSYCH_UP
	dbw 39, SCREECH
	dbw 42, PSYBEAM ; RG proto
	dbw 46, SLASH ; RG proto
	dbw 50, HYDRO_PUMP
	db 0 ; no more level-up moves
...
WeirduckEvosAttacks:
	...
	dbw 39, PSYCH_UP
	dbw 43, SCREECH
	dbw 46, PSYBEAM ; RG proto
	dbw 52, SLASH ; RG proto
	dbw 56, HYDRO_PUMP
	db 0 ; no more level-up moves
...
GolduckEvosAttacks:
	...
	dbw 14, WATER_GUN ; SW97
	dbw 19, CONFUSION
	dbw 22, SUPERSONIC ; RG proto & KEP
	dbw 25, FURY_SWIPES
	dbw 29, AMNESIA ; Stadium & HGSS
	dbw 33, GLARE ; RG proto
	dbw 41, PSYCH_UP
	dbw 45, SCREECH
	dbw 48, PSYBEAM ; RG proto
	dbw 56, SLASH ; RG proto
	dbw 60, HYDRO_PUMP
	db 0 ; no more level-up moves
...
PrimeapeEvosAttacks:
	dbww EVOLVE_TRADE, -1, ANNIHILAPE ; funny
	db 0 ; no more evolutions
	dbw 1, SCRATCH
	dbw 1, LEER
	dbw 1, UPPERCUT
...
PoliwhirlEvosAttacks:
	...
	dbww EVOLVE_ITEM, HEART_STONE, POLITOED
	db 0 ; no more evolutions
	dbw 1, BUBBLE
	dbw 1, WATER_SPORT
	dbw 7, HYPNOSIS
	...
	dbw 19, DOUBLESLAP
	dbw 25, RAIN_DANCE
	dbw 25, COMET_PUNCH ; RG proto
	dbw 33, LOW_KICK ; SW97
	dbw 39, BODY_SLAM
	dbw 45, BELLY_DRUM
	dbw 53, AMNESIA ; RBY
	dbw 59, HYDRO_PUMP
...
MachopEvosAttacks:
	...
	dbw 13, KARATE_CHOP
	dbw 19, SEISMIC_TOSS
	dbw 23, COMET_PUNCH ; RG proto & SW97
	dbw 28, FORESIGHT
	dbw 33, VITAL_THROW
	dbw 37, CROSS_CHOP
	dbw 43, SCARY_FACE
...
WeepinbellEvosAttacks:
	...
	dbww EVOLVE_ITEM, POISON_STONE, BELLIGNAN
	db 0 ; no more evolutions
	dbw 1, VINE_WHIP
	dbw 6, GROWTH
	dbw 11, WRAP
...
KoltaEvosAttacks:
	...
	dbw 1, GROWL
	dbw 4, TAIL_WHIP
	dbw 8, QUICK_ATTACK ; FRLG
	dbw 13, EMBER
	dbw 19, STOMP
	dbw 24, FLAME_WHEEL ; HGSS
	dbw 30, TAKE_DOWN
	dbw 36, FIRE_SPIN
	dbw 40, AGILITY
	dbw 45, FIRE_BLAST
...
SlowpokeEvosAttacks:
	...
	dbww EVOLVE_ITEM, HEART_STONE, SLOWKING
	db 0 ; no more evolutions
	dbw 1, CURSE
	dbw 1, TACKLE
	dbw 6, GROWL
	dbw 10, BIDE ; RG proto
	dbw 15, WATER_GUN
	dbw 20, CONFUSION
	dbw 25, PSYCH_UP ; FRLG
	dbw 29, DISABLE
	dbw 34, HEADBUTT
	dbw 39, SUPERSONIC ; RG proto
	dbw 43, AMNESIA
	dbw 48, PSYCHIC_M
	db 0 ; no more level-up moves
...
MagnetonEvosAttacks:
	...
	dbw 23, THUNDER_WAVE
	dbw 25, SPARK ; FRLG
	dbw 29, LIGHT_SCREEN ; LGPE
	dbw 30, TRI_ATTACK
	dbw 35, LOCK_ON
	dbw 42, SWIFT ; hey put that back. meanie.
	dbw 47, SCREECH
	dbw 55, ZAP_CANNON
	db 0 ; no more level-up moves
...
FarfetchDEvosAttacks:
	...
	dbw 13, LEER
	dbw 18, FURY_ATTACK
	dbw 23, WING_ATTACK ; SW97
	dbw 29, SWORDS_DANCE
	dbw 35, AGILITY
	dbw 40, DRILL_PECK ; KEP, from Luxwan
	dbw 44, SLASH
	dbw 50, FURY_CUTTER ; SW97
	dbw 55, FALSE_SWIPE
	db 0 ; no more level-up moves
...
DoduoEvosAttacks:
	...
	dbw 9, PURSUIT
	dbw 14, FURY_ATTACK
	dbw 22, QUICK_ATTACK ; HGSS
	dbw 26, RAGE
	dbw 30, DRILL_PECK
	dbw 37, TRI_ATTACK
	dbw 41, AGILITY
	dbw 45, THRASH ; LGPE
	dbw 54, JUMP_KICK ; LGPE
	db 0 ; no more level-up moves
...
MukEvosAttacks:
	...
	dbw 32, SCREECH
	dbw 38, ACID_ARMOR
	dbw 44, SUPERSONIC ; RG proto
	dbw 52, SLUDGE_BOMB
	db 0 ; no more level-up moves

ShellderEvosAttacks:
	dbww EVOLVE_ITEM, WATER_STONE, CLOYSTER
	dbww EVOLVE_ITEM, SLOWPOKETAIL, DISTURBAN
	db 0 ; no more evolutions
	dbw 1, TACKLE
	dbw 1, WITHDRAW
...
GastlyEvosAttacks:
	...
	dbw 16, CURSE
	dbw 20, NIGHT_SHADE
	dbw 24, POISON_GAS ; SW97
	dbw 28, CONFUSE_RAY
	dbw 33, DREAM_EATER
	dbw 37, DESTINY_BOND
	dbw 43, NIGHTMARE ; SW97
	dbw 49, SHADOW_BALL ; FRLG
	db 0 ; no more level-up moves
...
HaunterEvosAttacks:
	...
	dbw 35, DREAM_EATER
	dbw 41, DESTINY_BOND
	dbw 47, NIGHTMARE ; SW97
	dbw 55, SHADOW_BALL ; FRLG
	db 0 ; no more level-up moves
...
OnixEvosAttacks:
	...
	dbw 17, HARDEN
	dbw 23, RAGE
	dbw 27, DRAGONBREATH ; FRLG
	dbw 31, ROCK_HEAD
	dbw 36, SANDSTORM
	dbw 40, SLAM
	dbw 45, DIG ; SW97
	dbw 51, DOUBLE_EDGE ; FRLG
	db 0 ; no more level-up moves

DrowzeeEvosAttacks: ; mean look and cray could be here
	...
	dbw 20, HEADBUTT
	dbw 25, POISON_GAS
	dbw 30, DREAM_EATER ; LGPE
	dbw 34, CONFUSE_RAY ; SW97
	dbw 39, MEDITATE
	dbw 44, PSYCHIC_M
	dbw 48, MEAN_LOOK ; SW97
	dbw 52, PSYCH_UP
	dbw 56, FUTURE_SIGHT
	db 0 ; no more level-up moves
...
HypnoEvosAttacks:
	...
	dbw 20, HEADBUTT
	dbw 25, POISON_GAS
	dbw 32, DREAM_EATER ; LGPE
	dbw 36, CONFUSE_RAY ; SW97
	dbw 41, MEDITATE
	dbw 48, PSYCHIC_M
	dbw 52, MEAN_LOOK ; SW97
	dbw 56, PSYCH_UP
	dbw 62, FUTURE_SIGHT
	dbw 65, NIGHTMARE ; FRLG
	db 0 ; no more level-up moves
...
KrabbyEvosAttacks:
	...
	dbw 11, VICEGRIP
	dbw 16, HARDEN
	dbw 20, WATER_GUN ; SW97
	dbw 24, STOMP
	dbw 30, FALSE_SWIPE ; SW97
	dbw 35, GUILLOTINE
	dbw 39, PROTECT
	dbw 44, CRABHAMMER
	dbw 49, FLAIL ; FRLG
...
KinglerEvosAttacks:
	...
	dbw 20, WATER_GUN ; SW97
	dbw 24, STOMP
	dbw 28, METAL_CLAW ; FRLG
	dbw 32, FALSE_SWIPE ; SW97
	dbw 37, GUILLOTINE
	dbw 41, PROTECT
	dbw 48, CRABHAMMER
	dbw 53, FLAIL ; FRLG
...
ExeggcuteEvosAttacks:
	...
	dbw 44, SLEEP_POWDER
	dbw 50, SOLARBEAM
	dbw 56, SOFTBOILED ; 99 proto egg move
	db 0 ; no more level-up moves
...
ExeggutorEvosAttacks:
	...
	dbw 1, HYPNOSIS
	dbw 1, CONFUSION
	dbw 1, SWEET_SCENT ; SW97
	dbw 19, STOMP
	dbw 31, EGG_BOMB
	dbw 55, SOLARBEAM ; to match Alolan Eggy
	db 0 ; no more level-up moves
...
MarowakEvosAttacks:
	dbww EVOLVE_ITEM, HEART_STONE, GUARDIA
	db 0 ; no more evolutions
	dbw 1, GROWL
	dbw 5, TAIL_WHIP
	dbw 9, BONE_CLUB
...
HitmonleeEvosAttacks:
	...
	dbw 20, JUMP_KICK
	dbw 25, MIND_READER
	dbw 30, KARATE_CHOP ; Substitute for Brick Break
	dbw 35, FORESIGHT
	dbw 40, HI_JUMP_KICK
	dbw 45, ENDURE
	dbw 50, MEGA_KICK
...
LickitungEvosAttacks:
	...
	dbww EVOLVE_ITEM, POISON_STONE, LICKILORD
	dbww EVOLVE_TRADE, KINGS_ROCK, LICKILORD
	db 0 ; no more evolutions
	dbw 1, LICK
	dbw 1, MEGAPHONE
	dbw 7, SUPERSONIC
...
TangelaEvosAttacks:
	...
	dbww EVOLVE_ITEM, DUSK_STONE, JUNGELA
	db 0 ; no more evolutions
	dbw 1, CONSTRICT
	dbw 5, SLEEP_POWDER
	dbw 10, ABSORB
...
HorseaEvosAttacks:
	...
	dbw 7, SMOKESCREEN
	dbw 12, LEER
	dbw 18, QUICK_ATTACK ; SW97
	dbw 24, WATER_GUN
	dbw 29, FOCUS_ENERGY ; HGSS
	dbw 34, TWISTER
	dbw 39, BUBBLEBEAM ; HGSS
	dbw 45, AGILITY
	dbw 50, DRAGONBREATH ; SW97
	dbw 56, HYDRO_PUMP
	db 0 ; no more level-up moves
...
SeadraEvosAttacks:
	...
	dbw 24, WATER_GUN
	dbw 29, FOCUS_ENERGY ; HGSS
	dbw 32, PIN_MISSILE ; SW97
	dbw 36, TWISTER
	dbw 41, BUBBLEBEAM ; HGSS
	dbw 47, AGILITY
	dbw 54, DRAGONBREATH ; SW97
	dbw 60, HYDRO_PUMP
	db 0 ; no more level-up moves
...
BlastoiseEvosAttacks:
	...
	dbw 19, BITE
	dbw 24, RAPID_SPIN
	dbw 29, BUBBLEBEAM ; LGPE
	dbw 33, HEADBUTT ; LGPE
	dbw 39, RAIN_DANCE
	dbw 43, IRON_TAIL ; TM
	dbw 47, CURSE ; 99 proto
	dbw 54, SKULL_BASH
...
OrfryEvosAttacks:
	...
	dbw 25, FURY_ATTACK
	dbw 31, WATERFALL
	dbw 35, THRASH ; RG proto
	dbw 40, AGILITY
	dbw 45, HORN_DRILL
	dbw 49, HYDRO_PUMP ; RG proto
	db 0 ; no more level-up moves
...
GoldeenEvosAttacks:
	...
	dbw 27, FURY_ATTACK
	dbw 33, WATERFALL
	dbw 39, THRASH ; RG proto
	dbw 44, AGILITY
	dbw 49, HORN_DRILL
	dbw 55, HYDRO_PUMP ; RG proto
	dbw 59, MEGAHORN ; FRLG
	db 0 ; no more level-up moves
...
SeakingEvosAttacks:
	...
	dbw 27, FURY_ATTACK
	dbw 33, WATERFALL
	dbw 41, THRASH ; RG proto
	dbw 46, AGILITY
	dbw 51, HORN_DRILL
	dbw 59, HYDRO_PUMP ; RG proto
	dbw 63, MEGAHORN ; FRLG
	db 0 ; no more level-up moves
...
StaryuEvosAttacks:
	...
	dbw 5, WATER_GUN
	dbw 10, RAPID_SPIN
	dbw 15, SUPERSONIC ; Unused Egg move
	dbw 20, RECOVER
	dbw 25, SWIFT
	dbw 30, BUBBLEBEAM
...
StarmieEvosAttacks:
	...
	dbw 1, BUBBLEBEAM
	dbw 37, CONFUSE_RAY
	dbw 43, BARRIER ; Unused Egg move
	db 0 ; no more level-up moves
...
ScytherEvosAttacks:
	...
	dbww EVOLVE_ITEM, BLK_AUGURITE, KLEAVOR
	db 0 ; no more evolutions
	dbw 1, QUICK_ATTACK
	dbw 1, LEER
	dbw 6, FOCUS_ENERGY
...
ElectabuzzEvosAttacks:
	...
	dbw 1, QUICK_ATTACK
	dbw 1, LEER
	dbw 7, THUNDERSHOCK ; SW97
	dbw 13, THUNDER_WAVE ; SW97
	dbw 17, LOW_KICK ; From Elebebi
	dbw 21, SPARK ; SW97
	dbw 26, SWIFT
	dbw 30, THUNDERPUNCH
	dbw 38, SCREECH
...
ElectivireEvosAttacks:
	...
	dbw 52, LIGHT_SCREEN
	dbw 60, THUNDER
	dbw 65, DOUBLE_EDGE ; HGSS, Substitute for Giga Impact
	db 0 ; no more level-up moves
...
MagmarEvosAttacks:
	...
	dbw 13, SMOKESCREEN
	dbw 17, SMOG
	dbw 21, FLAME_WHEEL ; SW97
	dbw 26, CONFUSE_RAY
	dbw 30, FIRE_PUNCH
	dbw 38, FAINT_ATTACK ; HGSS
	dbw 44, FLAMETHROWER
	dbw 52, SUNNY_DAY
	dbw 60, FIRE_BLAST
	db 0 ; no more level-up moves
...
MagmortarEvosAttacks:
	...
	dbw 52, SUNNY_DAY
	dbw 60, FIRE_BLAST
	dbw 65, HYPER_BEAM ; HGSS
	db 0 ; no more level-up moves

PinsirEvosAttacks:
	dbww EVOLVE_TRADE, METAL_COAT, TRICULES
...
DittoEvosAttacks:
	dbww EVOLVE_TRADE, METAL_COAT, MIMMEO
	db 0 ; no more evolutions
	dbw 1, TRANSFORM
	db 0 ; no more level-up moves
...
MimmeoEvosAttacks:
	db 0 ; no more evolutions
	dbw 1, TRANSFORM
	dbw 30, PSYCH_UP ; copies stat boosts, thematically sound
	dbw 40, LIGHT_SCREEN
	dbw 50, REFLECT
	db 0 ; no more level-up moves
...
EeveeEvosAttacks:
	...
	dbww EVOLVE_ITEM, HEART_STONE, ESPEON
	dbbw EVOLVE_HAPPINESS, TR_NITE, UMBREON
	dbww EVOLVE_ITEM, POISON_STONE, UMBREON
...
OmanyteEvosAttacks:
	...
	dbw 1, WITHDRAW
	dbw 8, BITE
	dbw 14, ROCK_THROW ; KEP & Event
	dbw 19, WATER_GUN
	dbw 25, HORN_ATTACK ; SW97
	dbw 31, BIND ; SW97
	dbw 37, LEER
	dbw 43, PROTECT
	dbw 49, ANCIENTPOWER
	dbw 55, SPIKE_CANNON ; SW97
	dbw 61, HYDRO_PUMP
	db 0 ; no more level-up moves
...
KabutoEvosAttacks:
	...
	dbw 8, ABSORB
	dbw 14, ROCK_THROW ; KEP & Event
	dbw 19, WATER_GUN ; SW97
	dbw 25, SAND_ATTACK
	dbw 31, ENDURE
	dbw 37, MEGA_DRAIN
	dbw 43, SLASH ; SW97
	dbw 49, ANCIENTPOWER
	dbw 55, HYDRO_PUMP ; SW97, RBY
	dbw 59, ROCK_SLASH
	db 0 ; no more level-up moves
...
ArticunoEvosAttacks:
	...
	dbw 1, POWDER_SNOW
	dbw 5, MIST
	dbw 15, AURORA_BEAM ; SW97
	dbw 25, AGILITY
	dbw 35, MIND_READER
	dbw 45, HAZE ; SW97
	dbw 55, ICE_BEAM
	dbw 65, SAFEGUARD ; SW97
	dbw 75, REFLECT
	dbw 85, BLIZZARD
	db 0 ; no more level-up moves
...
ZapdosEvosAttacks:
	...
	dbw 35, DETECT
	dbw 45, DRILL_PECK
	dbw 55, THUNDERBOLT ; LGPE
	dbw 65, SCARY_FACE ; SW97
	dbw 75, LIGHT_SCREEN
	dbw 85, THUNDER
	db 0 ; no more level-up moves
...
MoltresEvosAttacks:
	...
	dbw 25, AGILITY
	dbw 35, ENDURE
	dbw 45, RECOVER ; 99 proto & hehehehehe
	dbw 55, FLAMETHROWER
	dbw 65, SAFEGUARD
	dbw 75, SKY_ATTACK
	dbw 85, SACRED_FIRE ; SW97
	db 0 ; no more level-up moves
