...
SquirtleEvosAttacks:
	dbbw EVOLVE_LEVEL, 16, WARTORTLE ; Give this man Curse
	db 0 ; no more evolutions
	dbw 1, TACKLE
	dbw 4, TAIL_WHIP
	dbw 7, BUBBLE
...
PsyduckEvosAttacks:
	...
	dbw 5, TAIL_WHIP
	dbw 10, DISABLE
	dbw 12, WATER_GUN ; SW97
	dbw 16, CONFUSION
	dbw 23, SCREECH
	dbw 31, PSYCH_UP
	dbw 37, PSYBEAM ; RG prototype
	dbw 40, FURY_SWIPES
	dbw 50, HYDRO_PUMP
	db 0 ; no more level-up moves
...
; these guys get like every fighting move in the rg proto and they should here but i am too stupid
MankeyEvosAttacks:
...
ArcanineEvosAttacks:
	...
	dbw 1, FLAME_WHEEL
	dbw 50, EXTREMESPEED
	dbw 60, SACRED_FIRE ; SW97 lmfao
	db 0 ; no more level-up moves

PoliwagEvosAttacks: ; should get amnesia
...
VictreebelEvosAttacks:
	...
	dbw 1, RAZOR_LEAF
	dbw 40, SLEEP_POWDER
	dbw 48, GIGA_DRAIN ; vibes cus bellignan
	db 0 ; no more level-up moves
...
MagnetonEvosAttacks:
	...
	dbw 27, LOCK_ON
	dbw 35, TRI_ATTACK
	dbw 38, SWIFT ; hey put that back. meanie.
	dbw 43, SCREECH
	dbw 53, ZAP_CANNON
	db 0 ; no more level-up moves
...
DewgongEvosAttacks:
	...
	dbw 32, TAKE_DOWN
	dbw 43, ICE_BEAM
	dbw 48, SAFEGUARD ; WHY WAS THIS L60
...
ShellderEvosAttacks:
	...
	dbw 1, TACKLE
	dbw 1, WITHDRAW
	dbw 1, SMOKESCREEN ; RG prototype
	dbw 9, SUPERSONIC
	dbw 17, AURORA_BEAM
	dbw 25, PROTECT
	dbw 33, LEER
...
HitmonchanEvosAttacks:
	db 0 ; no more evolutions
	dbw 1, COMET_PUNCH
	; dbw 1, UPPERCUT get this implemented
	dbw 7, AGILITY
	dbw 13, PURSUIT
	dbw 26, THUNDERPUNCH
	dbw 26, ICE_PUNCH
...
ArticunoEvosAttacks:
	...
	dbw 1, HAZE ; SW97
	dbw 13, MIST
	dbw 20, AURORA_BEAM ; SW97
	dbw 25, AGILITY
	dbw 37, MIND_READER
	dbw 49, ICE_BEAM
	dbw 61, REFLECT
	dbw 73, BLIZZARD
	dbw 80, SAFEGUARD ; SW97
	db 0 ; no more level-up moves
...
MoltresEvosAttacks: ; this fucker got recover once and im really tempted to add it in
	db 0 ; no more evolutions
	dbw 1, WING_ATTACK
	dbw 1, EMBER
	dbw 1, LEER ; SW97, RBY
	...
	dbw 61, SAFEGUARD
	dbw 73, SKY_ATTACK
	dbw 80, SACRED_FIRE ; SW97 ayooooo
	db 0 ; no more level-up moves
...
MewtwoEvosAttacks: ; could get psybeam
	db 0 ; no more evolutions
	dbw 1, CONFUSION
	dbw 1, DISABLE
	dbw 11, BARRIER
