...
MapGroup_Lavender:
	...
	map LavenderCrypt, TILESET_CAVE, INDOOR, LANDMARK_LAVENDER_TOWN, MUSIC_LAVENDER_TOWN, TRUE, PALETTE_DAY, FISHGROUP_NONE
...
MapGroup_ThreeIsland:	; 30
	...
	map BerryForest, TILESET_CAVE, CAVE, LANDMARK_THREE_ISLAND, MUSIC_CHERRYGROVE_CITY, TRUE, PALETTE_AUTO, FISHGROUP_SHORE
