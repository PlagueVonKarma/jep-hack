...
; - db -1 ; end
; IF ANY OF THE NEW TRAINERS HAVE ANY MONS WITH HELD ITEMS PLEASE CHECK THAT THEY'RE CORRECT. I DID FIND AND REPLACE ON THE ITEMS I KNEW WERE AROUND BECAUSE IT WOULD TAKE FOREVER OTHERWISE.
